...
2. Removed the unnecessary conversion of board[i][j] to string in print_board function.
3. Removed the unnecessary check for j + 1 != 9 in print_board function.
4. Removed the unnecessary check for i + 1 != 9 in print_board function.
5. Removed the unnecessary check for board[row][col] != 0 in fill_cells function.
6. Removed the unnecessary check for board[i][j] == 0 in find_empty function.
7. The time complexity of the original code is O(9^81) and the space complexity is O(1).
8. The time complexity of the optimized code is O(9^81) and the space complexity is O(1).
